...
std::deque<position>::iterator moneyManager::remPosition(std::deque<position>::iterator iter) {
...
std::deque<position>* moneyManager::getPositions() {
  return &positions;
}

std::deque<position>* moneyManager::getPositionsHistory() {
